	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			while (true) {
				...
				out.println(phiMoteurToPhi(motorRot.getTachoCount()));
				System.out.println("jai envoye phi" + phiMoteurToPhi(motorRot.getTachoCount())); // LCD.drawString("",
																									// x, y);
				out.flush();
